...
namespace YurtOtomasyonu2
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtOtomasyonuDataSet3.Giderler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderlerTableAdapter.Fill(this.yurtOtomasyonuDataSet3.Giderler);
